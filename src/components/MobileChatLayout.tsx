...
import FriendRequestsSidebarOption from './ui/FriendRequestsSidebarOption'
                  ...
                  <Dialog.Panel className='pointer-events-auto w-screen max-w-md'>
                    <div className='flex h-full flex-col overflow-hidden bg-white py-6 shadow-xl'>
                      ...
                      <div className='relative mt-6 flex-1 px-4 sm:px-6'>
                        ...
                        <nav className='h-full flex flex-1 flex-col'>
                          <ul
                            role='list'
                                  ...
                                  return (
                                    <li key={option.name}>
                                      <Link
                                        ...
                                        <span className='text-gray-700 border-gray-200 group-hover:border-indigo-600 group-hover:text-indigo-600 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium bg-white'>
